...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative flex items-center bg-navy text-white overflow-hidden py-10 sm:py-16 lg:py-20"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl sm:rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 p-4 sm:p-7 shadow-2xl overflow-hidden hover:border-gold/30 transition-all duration-500">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="relative h-40 sm:h-48 lg:h-44 rounded-xl sm:rounded-2xl overflow-hidden border border-white/15 group shadow-inner">
                    <img
                  ...
                  {/* Title & Description */}
                  <div>
                    <h3 className="font-display text-base sm:text-xl font-bold text-white mb-1 line-clamp-1">
                      {activeData.title}
                    </h3>
